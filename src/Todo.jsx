...
export default function Todo() {
    ...
    const apiUrl = "https://todolist-bakend.onrender.com"
    ...
    return <>
        <div className=" bg-dark container w-100">
          <div className="row py-2 text-center bg-success text-light">
        ...
        <div className="row">
            ...
            <div className="form-group d-flex gap-2">
                ...
                <input placeholder="Description" onChange={(e) => setEditDesciption(e.target.value)} value={description} className="form-control" type="text" />
    ...
    {todos.map((item) => (
      ...
      >
        <div className="d-flex flex-column me-2">
          {editId !== item._id ? (
            // Show title and description if this item is not being edited
            <>
              <span className="fw-bold">{item.title}</span>
              <span>{item.description}</span>
            </>
          ) : (
            // Show input fields if this item is being edited
            <div className="form-group d-flex gap-2">
              <input
                placeholder="Title"
